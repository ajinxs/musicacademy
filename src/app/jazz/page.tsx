...
function Guitar() {
  return (
    <div className="min-h-screen bg-black py-12 pt-36 w-full text-center">
        ...
        <h1 className="text-lg md:text-3xl text-center font-sans font-bold mb-1 text-white">Jazz</h1>

        <div className="flex flex-wrap justify-center">

            <p className="text-base font-normal text-balance text-center mt-5">
                Starting your jazz journey? This course is for you! We&apos;ll learn all the basic skills and build the muscles you need 
                to play the jazz with confidence. By the end of Basic, you&apos;ll know how to play the eight essential open chords, 
        ...
        <div className="flex flex-wrap justify-center">
            ...
            <table className="table-auto mt-6">
                ...
                <tbody>
                    <tr>
                        <td>12 Bar Blues Bass Line</td>
                        <td>6</td>
                        <td>$500</td>
                    </tr>
                    <tr>
                        <td>Professional Jazz Chords</td>
                        <td>13</td>
                        <td>$700</td>
                    </tr>
                    <tr>
                        <td>Improvise Over The Blues</td>
                        <td>13</td>
                        <td>$1500</td>
                    </tr>
                    <tr>
                        <td>Improvisation Licks</td>
                        <td>13</td>
                        <td>$1000</td>
                    </tr>
                </tbody>
